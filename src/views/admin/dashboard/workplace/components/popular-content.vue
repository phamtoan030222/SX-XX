    ...
    <a-card class="general-card" :header-style="{ paddingBottom: '0' }" :body-style="{ padding: '17px 20px 21px 20px' }">
      ...
      <a-space direction="vertical" :size="10" fill>
        <a-table :data="renderList" :pagination="false" :bordered="false" :scroll="{ x: '100%', y: '264px' }">
          <template #columns>
            <a-table-column title="Xếp hạng" data-index="key"></a-table-column>
            <a-table-column title="Tiêu đề nội dung" data-index="title">
            ...
            <a-table-column title="Nhấp chuột" data-index="clickNumber"></a-table-column>
            <a-table-column
              title="Tăng hàng ngày"
