...
export class VoucherApiService {
  ...
  static async createVoucher(voucher: VoucherValidateRequest): Promise<ResponseObject<null>> {
    try {
      const response: AxiosResponse<ResponseObject<null>> = await axios.post(`${BASE_URL}/addVoucher`, voucher, {
        headers: {
  ...
  static async updateVoucher(voucher: VoucherValidateRequest): Promise<ResponseObject<AdVoucherResponse>> {
    try {
      const response: AxiosResponse<ResponseObject<AdVoucherResponse>> = await axios.put(`${BASE_URL}/updateVoucher`, voucher, {
        headers: {
          'Content-Type': 'application/json',
        },
      })
  ...
  static async deactivateVoucher(id: string): Promise<ResponseObject<AdVoucherResponse>> {
    try {
      const response: AxiosResponse<ResponseObject<AdVoucherResponse>> = await axios.patch(`${BASE_URL}/${id}/deactivate`)
      return response.data
    } catch (error: any) {
  ...
  static async deleteVoucher(id: string): Promise<ResponseObject<null>> {
    try {
      const response: AxiosResponse<ResponseObject<null>> = await axios.delete(`${BASE_URL}/${id}/delete`)
      return response.data
    } catch (error: any) {
...
export class VoucherUtils {
  ...
  static canDeactivateVoucher(voucher: AdVoucherResponse): boolean {
    const now = Date.now()
    return voucher.voucherStatus === 0 && voucher.startTime <= now && voucher.endTime > now
  }
}
